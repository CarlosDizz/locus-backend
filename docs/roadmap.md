...
1. Completado: congelar V1 con la etiqueta `v1-production-before-v2-cutover-20260908`.
2. Completado: promover V2 a la raiz del repositorio y retirar el codigo V1 de la rama.
3. Completado: anadir CI y Compose de produccion para todo el stack.
4. Crear y verificar el backup de la base de produccion.
5. Importar a `locus_v2` y sustituir V1 en EC2 conservando dominio y volumen MySQL.
6. Ejecutar smoke tests, observar y conservar la base `locus` para rollback.
